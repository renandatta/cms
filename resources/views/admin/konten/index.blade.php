...
@section('content')
    <div class="row mt-5">
        ...
        <div class="col-6 text-right">
            <a href="{{ route('admin.konten.info') }}" class="btn btn-primary mt-3 px-4 font-weight-bold" style="border-radius: 20px;">Tambah</a>
        </div>
    </div>
    <div class="row">
...
@push('scripts')
    <script>
        ...
        function search_data(page = '') {
            ...
            $.post("{{ route('admin.konten.search') }}?page=" + selectedPage, {
                _token: '{{ csrf_token() }}',
                action: ['edit'],
            }, function (result) {
